...
@section('actionsAdmin')
    <article class="col-12 m-0 p-3 d-flex flex-column justify-content-start align-items-start row sectSubscriptions">
        ...
        <div class="col-12 m-0 p-0 d-flex flex-column justify-content-between align-items-start row formData">
            ...
            <form class="col-12 m-0 p-2 d-flex flex-column justify-contetn-center align-items-start row" id="formEditVaccine">
                <input type="number" hidden id="id_vaccine" name="id_vaccine" value="{{$vaccine->id_vaccine}}">
                ...
                <section class="col-12 m-0 p-0 d-flex flex-row row">
                    ...
                    <div class="col-6 m-0 p-2">
                        ...
                        <input type="text" placeholder="Ingresa el nombre" name="vaccine" id="vaccine" value="{{$vaccine->vaccine}}">
                    </div>
                    <div class="col-6 m-0 p-2">
                        <label for="how_often">
                            Cada cuanto (meses)
                        </label>
                        <input type="number" placeholder="Cada cuanto" name="how_often" id="how_often" value="{{$vaccine->how_often}}">
                    </div>
                    

                    <div class="col-12 m-0 p-2 d-flex flex-column">
                        <label for="description">Descripción</label>
                        <textarea name="description" id="description" cols="30" rows="10" placeholder="Ingresa la descripcion del medicamnento">{{$vaccine->description}}</textarea>
                    </div>
                ...
                <div class="m-0 p-0 col-12 d-flex flex-row row">
                    ...
                    <div class="col-3 m-0 p-2">
                        <button type="submit" class="btnSmart btn-mainGreen">Actualizar Vacuna</button>
                    </div>
                    <div class="col-3 p-2">
