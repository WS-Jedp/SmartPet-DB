...
<article class="col-12 d-flex flex-column row m-0 p-0 justify-content-center align-items-center p-3">
        ...
        <form class="d-flex flex-column align-items-center p-2 col-12 p-3 row" id="formLogin">
           <label for="username" class="col-12 mb-4 p-0">
                <div class="form-login col-12 col-md-12 m-0 p-0">
                    <input type="text" name="username" placeholder="Ingresa tu usuario" required id="inputText">
           ...
           <label for="password" class="col-12 mb-4 p-0">
                <div class="form-login col-12 col-md-12 m-0 p-0">
                    <input type="password" name="password" placeholder="Ingresa tu contraseña" required id="inputText">
                    <div class="input-login"></div>
                </div>
           </label>
